...
E(g1)[E(g1)$sector=="Agriculture"]$color <-"#004e24"
E(g1)[E(g1)$sector=="Environment"]$color <-"#00b294"
E(g1)[E(g1)$sector=="Flooding"]$color <-"#00bcf2"
E(g1)[E(g1)$sector=="Groundwater"]$color <-"#00188f"
E(g1)[E(g1)$sector=="Oil and Gas"]$color <-"#e81123"
E(g1)[E(g1)$sector=="Rural Utilities"]$color <-"#ff8C00"
E(g1)[E(g1)$sector=="Innovation"]$color <-"#ec008c"
E(g1)[E(g1)$sector=="Municipal"]$color <-"#c77adb"
...
V(g1)[which(V(g1)$type=="Utilities")]$shape<-"database"
V(g1)[which(V(g1)$type=="Physical Feature")]$shape<-"circle"
V(g1)[which(V(g1)$type=="Academic")]$shape<-"star"
...
E(g1_agriculture)[E(g1_agriculture)$type=="Money"]$color <-"#004e24" #18% of all ties
E(g1_agriculture)[E(g1_agriculture)$type=="Information"]$color <-"black" #18% of all ties
E(g1_agriculture)[E(g1_agriculture)$type=="Membership"]$color <-"#c77adb" #%11% of all ties
E(g1_agriculture)[E(g1_agriculture)$type=="Lobbying"]$color <-"#00188f" #10% of all ties
E(g1_agriculture)[E(g1_agriculture)$type=="Water"]$color <-"#00bcf2" #8% of all ties
E(g1_agriculture)[E(g1_agriculture)$type=="Regulation/Oversight"]$color <-"#e81123" #6% of all ties
...
V(g1_agriculture)[which(V(g1_agriculture)$type=="Government")]$color<-"#e81123"
V(g1_agriculture)[which(V(g1_agriculture)$type=="NGO")]$color<-"#00188f"
V(g1_agriculture)[which(V(g1_agriculture)$type=="Private")]$color<-"#004e24"
V(g1_agriculture)[which(V(g1_agriculture)$type=="Utilities")]$color<-"#ff8C00"
...
lnodes_ag <-
  data.frame(
    ...
    color.background = c("#e81123", "#00188f", "#004e24", "#ff8C00", "white", "white", "white"),

...
V(g1)[which(V(g1)$type=="Government")]$color<-"#e81123"
V(g1)[which(V(g1)$type=="NGO")]$color<-"#00188f"
V(g1)[which(V(g1)$type=="Private")]$color<-"#004e24"
V(g1)[which(V(g1)$type=="Utilities")]$color<-"#ff8C00"
V(g1)[which(V(g1)$type=="Physical Feature")]$color<-"#black"
V(g1)[which(V(g1)$type=="Academic")]$color<-"#00bcf2"
V(g1)[which(V(g1)$type=="Public")]$color<- "#c77adb"
...
E(g1_flooding)[E(g1_flooding)$type=="Money"]$color <-"#004e24" #18% of all ties
E(g1_flooding)[E(g1_flooding)$type=="Information"]$color <-"black" #18% of all ties
E(g1_flooding)[E(g1_flooding)$type=="Membership"]$color <-"#c77adb" #%11% of all ties



ledges_flood <-
  data.frame(
    label = c("Money", "Information", "Membership", "Other"),
    arrows = c("to"),
    color = c("#004e24", "black", "#c77adb", "gray")
  )


V(g1_flooding)[which(V(g1_flooding)$type=="Government")]$color<-"#e81123"
V(g1_flooding)[which(V(g1_flooding)$type=="NGO")]$color<-"#00188f"
V(g1_flooding)[which(V(g1_flooding)$type=="Private")]$color<-"#004e24"
V(g1_flooding)[which(V(g1_flooding)$type=="Utilities")]$color<-"#ff8C00"
V(g1_flooding)[which(V(g1_flooding)$type=="Physical Feature")]$color<-"#ff8C00"
V(g1_flooding)[which(V(g1_flooding)$type=="Academic")]$color<-"#00bcf2"
V(g1_flooding)[which(V(g1_flooding)$type=="Public")]$color<- "#c77adb"
...
E(g1_groundwater)[E(g1_groundwater)$type=="Money"]$color <-"#004e24" #18% of all ties
E(g1_groundwater)[E(g1_groundwater)$type=="Information"]$color <-"black" #18% of all ties
E(g1_groundwater)[E(g1_groundwater)$type=="Membership"]$color <-"#c77adb" #%11% of all ties
E(g1_groundwater)[E(g1_groundwater)$type=="Regulation/Oversight"]$color <-"#e81123" #6% of all ties
E(g1_groundwater)[E(g1_groundwater)$type=="Advocacy/Policy Preference"]$color <-"#00bcf2" #40% of ENV ties
...
V(g1_groundwater)[which(V(g1_groundwater)$type=="Government")]$color<-"#e81123"
V(g1_groundwater)[which(V(g1_groundwater)$type=="NGO")]$color<-"#00188f"
V(g1_groundwater)[which(V(g1_groundwater)$type=="Private")]$color<-"#004e24"
V(g1_groundwater)[which(V(g1_groundwater)$type=="Utilities")]$color<-"#ff8C00"
V(g1_groundwater)[which(V(g1_groundwater)$type=="Physical Feature")]$color<-"#ff8C00"
V(g1_groundwater)[which(V(g1_groundwater)$type=="Academic")]$color<-"#00bcf2"
V(g1_groundwater)[which(V(g1_groundwater)$type=="Public")]$color<- "#c77adb"
...
E(g1_innovation)[E(g1_innovation)$type=="Money"]$color <-"#004e24" #18% of all ties
E(g1_innovation)[E(g1_innovation)$type=="Information"]$color <-"black" #18% of all ties
E(g1_innovation)[E(g1_innovation)$type=="Water"]$color <-"#00bcf2" #8% of all ties
...
ledges_innovate <-
  data.frame(
    ...
    arrows = c("to"),
    color = c("#004e24", "black", "00bcf2", "gray")
  )


V(g1_innovation)[which(V(g1_innovation)$type=="Government")]$color<-"#e81123"
V(g1_innovation)[which(V(g1_innovation)$type=="NGO")]$color<-"#00188f"
V(g1_innovation)[which(V(g1_innovation)$type=="Private")]$color<-"#004e24"
V(g1_innovation)[which(V(g1_innovation)$type=="Utilities")]$color<-"#ff8C00"
V(g1_innovation)[which(V(g1_innovation)$type=="Physical Feature")]$color<-"#ff8C00"
V(g1_innovation)[which(V(g1_innovation)$type=="Academic")]$color<-"#00bcf2"
V(g1_innovation)[which(V(g1_innovation)$type=="Public")]$color<- "#c77adb"
...
E(g1_municipal)[E(g1_municipal)$type=="Money"]$color <-"#004e24" #18% of all ties
E(g1_municipal)[E(g1_municipal)$type=="Information"]$color <-"black" #18% of all ties
E(g1_municipal)[E(g1_municipal)$type=="Water"]$color <-"#e81123" #8% of all ties
...
ledges_muni <-
  data.frame(
    ...
    arrows = c("to"),
    color = c("#004e24", "black", "#e81123", "#ec008c", "00bcf2", "gray")
  )


V(g1_municipal)[which(V(g1_municipal)$type=="Government")]$color<-"#e81123"
V(g1_municipal)[which(V(g1_municipal)$type=="NGO")]$color<-"#00188f"
V(g1_municipal)[which(V(g1_municipal)$type=="Private")]$color<-"#004e24"
V(g1_municipal)[which(V(g1_municipal)$type=="Utilities")]$color<-"#ff8C00"
V(g1_municipal)[which(V(g1_municipal)$type=="Physical Feature")]$color<-"#ff8C00"
V(g1_municipal)[which(V(g1_municipal)$type=="Academic")]$color<-"#00bcf2"
V(g1_municipal)[which(V(g1_municipal)$type=="Public")]$color<- "#c77adb"
...
E(g1_oilandgas)[E(g1_oilandgas)$type=="Information"]$color <-"black" #18% of all ties
...
ledges_og <-
  data.frame(
    ...
    arrows = c("to"),
    color = c("black", "#00188f", "#ec008c", "#00b294", "gray")
  )



V(g1_oilandgas)[which(V(g1_oilandgas)$type=="Government")]$color<-"#e81123"
V(g1_oilandgas)[which(V(g1_oilandgas)$type=="NGO")]$color<-"#00188f"
V(g1_oilandgas)[which(V(g1_oilandgas)$type=="Private")]$color<-"#004e24"
V(g1_oilandgas)[which(V(g1_oilandgas)$type=="Utilities")]$color<-"#ff8C00"
V(g1_oilandgas)[which(V(g1_oilandgas)$type=="Physical Feature")]$color<-"#ff8C00"
V(g1_oilandgas)[which(V(g1_oilandgas)$type=="Academic")]$color<-"#00bcf2"
V(g1_oilandgas)[which(V(g1_oilandgas)$type=="Public")]$color<- "#c77adb"
...
E(g1_rural)[E(g1_rural)$type=="Money"]$color <-"#004e24" #18% of all ties
E(g1_rural)[E(g1_rural)$type=="Information"]$color <-"orange" #18% of all ties
E(g1_rural)[E(g1_rural)$type=="Membership"]$color <-"#c77adb" #%11% of all ties
E(g1_rural)[E(g1_rural)$type=="Water"]$color <-"#00b294" #8% of all ties
...
V(g1_rural)[which(V(g1_rural)$type=="Government")]$color<-"#e81123"
V(g1_rural)[which(V(g1_rural)$type=="NGO")]$color<-"#00188f"
V(g1_rural)[which(V(g1_rural)$type=="Private")]$color<-"#004e24"
V(g1_rural)[which(V(g1_rural)$type=="Utilities")]$color<-"#ff8C00"
V(g1_rural)[which(V(g1_rural)$type=="Physical Feature")]$color<-"#ff8C00"
V(g1_rural)[which(V(g1_rural)$type=="Academic")]$color<-"#00bcf2"
V(g1_rural)[which(V(g1_rural)$type=="Public")]$color<- "#c77adb"

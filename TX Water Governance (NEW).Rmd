...
#E(g1_environment)[E(g1_environment)$type=="Money"]$color <-"#004e24" #18% of all ties
E(g1_environment)[E(g1_environment)$type=="Information"]$color <-"black" #18% of all ties
#E(g1_environment)[E(g1_environment)$type=="Membership"]$color <-"#c77adb" #%11% of all ties
E(g1_environment)[E(g1_environment)$type=="Lobbying"]$color <-"#00188f" #10% of all ties
#E(g1_environment)[E(g1_environment)$type=="Water"]$color <-"#00bcf2" #8% of all ties
#E(g1_environment)[E(g1_environment)$type=="Regulation/Oversight"]$color <-"#e81123" #6% of all ties
...
ledges_env <-
  data.frame(
    ...
    arrows = c("to"),
    color = c("black", "#00188f", "#ec008c", "#c77adb", "gray")
  )



V(g1_environment)[which(V(g1_environment)$type=="Government")]$color<-"#e81123"
V(g1_environment)[which(V(g1_environment)$type=="NGO")]$color<-"#00188f"
V(g1_environment)[which(V(g1_environment)$type=="Private")]$color<-"#004e24"
V(g1_environment)[which(V(g1_environment)$type=="Utilities")]$color<-"#ff8C00"
V(g1_environment)[which(V(g1_environment)$type=="Physical Feature")]$color<-"#ff8C00"
V(g1_environment)[which(V(g1_environment)$type=="Academic")]$color<-"#00bcf2"
V(g1_environment)[which(V(g1_environment)$type=="Public")]$color<- "#c77adb"

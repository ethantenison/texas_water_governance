...
lnodes <- data.frame(label = c("Agriculture","Environment","Flooding","Groundwater","Oil and Gas", "Rural"),
color.background = c("brown", "green", "darkred","orange", "red", "blue"),
color.border = c("black","black","black","black","black","black"),
shape=c("line","line","line","line","line","line"))
...
#E(g1)$Strength[E(g1)$Strength == "Communication"] <- 1
#E(g1)$Strength[E(g1)$Strength == "Coordination"] <- 2
#E(g1)$Strength[E(g1)$Strength == "Collaboration"] <-3
